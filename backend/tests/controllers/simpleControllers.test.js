...
const cases = [
  ...
  [companyController, 'handleCreateNewCompany', companyService, 'handleCreateNewCompany', body],
  [companyController, 'handleUpdateCompany', companyService, 'handleUpdateCompany', body],
  ...
  [companyController, 'handleAddUserCompany', companyService, 'handleAddUserCompany', body],
  ...
  [companyController, 'getAllUserByCompanyId', companyService, 'getAllUserByCompanyId', query],
  [companyController, 'handleQuitCompany', companyService, 'handleQuitCompany', body],
  ...
  [reviewController, 'handleCreateReview', reviewService, 'handleCreateReview', body],
  [reviewController, 'getReviewByCompany', reviewService, 'getReviewByCompany', query],
  [reviewController, 'handleDeleteReview', reviewService, 'handleDeleteReview', body],
  ...
  [packageCvController, 'paymentOrderSuccess', packageCvService, 'paymentOrderSuccess', body],
  ...
  [packageCvController, 'getHistoryTrade', packageCvService, 'getHistoryTrade', query],
  ...
  [packagePostController, 'paymentOrderSuccess', packagePostService, 'paymentOrderSuccess', body],
  ...
  [packagePostController, 'getHistoryTrade', packagePostService, 'getHistoryTrade', query],
