import { logoutServer, startGoogleLink } from '../../auth/authClient';
                ...
                <ul className="navbar-nav navbar-nav-right" style={{ flexDirection: "row", alignItems: "center" }}>
                    ...
                    <li className="nav-item nav-profile dropdown" ref={profileRef}>
                        ...
                        >
                            ...
                            {process.env.REACT_APP_GOOGLE_SSO_ENABLED === 'true' &&
                                <button type="button" className="dropdown-item" onClick={() => startGoogleLink().catch(() => window.alert('Không thể liên kết Google lúc này.'))}>
