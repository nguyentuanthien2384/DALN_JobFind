...
describe('real HTTP request contracts', () => {
    it.each([
        ...
        ['jobRepost', jobClient.repostJob, [7, bodyExamples.JobRepost.timeEnd, { idempotencyKey: 'repost-test', expectedRevision: 'jv1-' + 'a'.repeat(64) }]],
    ...
    it.each([
        ...
        ['jobRepost', { body: { ...bodyExamples.JobRepost, expectedRevision: null } }],
        ['jobRepost', { body: { ...bodyExamples.JobRepost, expectedRevision: 'wrong' } }],
