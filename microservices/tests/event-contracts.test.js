...
describe('frozen payload v1 contracts', () => {
    ...
    it.each([
        ...
        ...['ai.parse_resume', 'ai.generate_cv', 'ai.match_cv', 'ai.cover_letter'].map((key) => [key, { ...eventExamples[key], jobId: {} }]),
        ['ai.generate_cv', { taskId: 'task-1', sourceText: 'Candidate', language: 'fr' }],
        ['ai.generate_cv', { taskId: 'task-1', sourceText: ' ', language: 'vi' }],
        ['ai.match_cv', { ...eventExamples['ai.match_cv'], fileBase64: 'c3ludGhldGlj' }],
