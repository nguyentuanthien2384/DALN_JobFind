...
export const operations = [
    ...
    op('aiGenerateCv', 'jobs', 'post', '/ai/generate-cv', P.AI_CANDIDATE_USE, { body: 'GenerateCv', response: 'AcceptedTask', status: 202, idempotency: true }),
    op('aiMatchCv', 'jobs', 'post', '/ai/match-cv', [P.AI_CANDIDATE_USE, P.AI_RECRUITER_USE], { body: 'MatchCv', response: 'AcceptedTask', status: 202, idempotency: true }),
    ...
    op('aiTaskGet', 'jobs', 'get', '/ai/tasks/:taskId', [P.AI_CANDIDATE_USE, P.AI_RECRUITER_USE], { params: object({ taskId }, ['taskId']), response: 'Task' }),
