...
1. **Chuyển đăng lại sang Job Core có kiểm soát**. Tạo mới đã có tùy chọn ở 2r, đọc/sửa ở 2s; mặc định/stack đang phục vụ chưa bật Core. Giữ đối chiếu ý định cũ theo writer đã lưu; không đổi ngày/revision/key của lần đăng lại đang treo. Quy tắc 2q: mọi sửa thực sự về PS3, manual ở luồng cũ và AI ở Core; no-op không gọi lại AI. Giữ các giới hạn AI chỉ đánh giá tiêu đề/HTML, client không gửi key/revision và ý định/tab độc lập. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
