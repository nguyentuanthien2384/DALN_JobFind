...
1. **Nghiệm thu xuyên màn hình và vai trò trên stack local cách ly trước khi bật cờ**: tạo → danh sách → sửa → đăng lại → thông tin kiểm duyệt. Tạo 2r, xem/sửa 2s, đăng lại 2t và workspace 2u đã có tùy chọn Core; mặc định/stack đang phục vụ chưa bật. Giữ writer/key/revision/ngày của yêu cầu đã lưu và không dùng trạng thái hiện tại thay receipt. Manual ở luồng cũ, AI ở Core chỉ đánh giá tiêu đề/HTML; thông tin review chưa bao gồm lý do/lịch sử AI đầy đủ.
