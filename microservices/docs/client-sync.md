...
1. Tiếp tục **HTTP idempotency legacy create/repost và vòng đời key/payload trên AddPost**, từng luồng một: key/ý định/phản hồi cùng quota/outbox, replay không trừ lại, cùng key khác payload bị từ chối và kiểm tra lại quyền khi replay. Tạo 2j/đăng lại 2k và manual/edit 2g–2i đã có outbox; revision không thay thế idempotency. Sau đó thống nhất thông báo Core/legacy và chuyển từng màn hình. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
