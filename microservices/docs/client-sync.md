...
1. Tiếp tục **HTTP idempotency đăng lại legacy và vòng đời key/payload của cửa sổ đăng lại**: tạo mới có mã/AddPost đã xong ở 2l, nhưng repost 2k vẫn có thể tạo nhiều bản dù revision nguồn giữ nguyên. Cần lưu key/ý định/phản hồi cùng quota/outbox, kiểm tra lại quyền khi replay và giữ key/ngày qua refresh. Sau đó thống nhất thông báo Core/legacy và chuyển từng màn hình; còn client tạo mới không gửi key. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
