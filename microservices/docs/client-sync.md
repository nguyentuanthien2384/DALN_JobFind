...
1. **Chuyển từng màn hình đăng tin sang Job Core bằng chế độ rõ ràng**, không tự đổi endpoint cho ý định legacy đang treo. Quy tắc sửa/duyệt đã chốt ở 2q: mọi thay đổi thực sự về PS3, manual ở luồng cũ và AI ở Core; no-op không gọi lại AI. Các bước 2l–2p đã có key/payload, revision, điều kiện đăng lại và thông báo sau duyệt. Giữ các giới hạn AI chỉ đánh giá tiêu đề/HTML, client không gửi key/revision và ý định/tab độc lập. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
