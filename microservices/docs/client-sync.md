...
1. Hoàn thiện outbox cho publisher legacy, bắt đầu từ tin/kiểm duyệt đã khóa giao dịch ở 2f: quyết định và ý định thông báo phải lưu cùng nhau; bảo đảm tương thích consumer, tránh gửi cả mail trực tiếp lẫn event cho cùng thông báo. Sau đó mới chuyển quyền sở hữu từng luồng ghi. Schema event đúng không tự bảo đảm gửi không mất.
