...
1. Tiếp tục **đăng lại tin legacy trên AddPost**: kiểm tra lại quyền/tin nguồn trong transaction, giữ quota/nội dung của tin gốc, bổ sung `job.created` cùng lần ghi và xử lý kết quả HTTP không chắc chắn. Tạo tin mới đã cùng outbox ở 2j; manual notification 2g, Search manual 2h và sửa tin 2i đã cùng transaction. Sau đó hoàn tất HTTP idempotency/vòng đời key/payload và thống nhất thông báo Core/legacy trước chuyển từng màn hình. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
