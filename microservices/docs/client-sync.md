...
1. Tiếp tục **thống nhất vòng đời sửa/duyệt AI–manual** trước khi chuyển màn hình đăng tin sang Job Core: sửa nội dung/metadata, trạng thái chờ duyệt và quyết định thủ công không được bị kết quả cũ ghi đè. Tạo mới có mã/AddPost xong ở 2l; đăng lại có mã/giữ ngày–revision xong ở 2m; thông báo Core sau duyệt ở 2n; điều kiện đăng lại/quyền công ty và revision Core ở 2o; điều kiện follower manual ở 2p. Còn client không gửi key/revision và giới hạn ý định/tab độc lập. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
