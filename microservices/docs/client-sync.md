...
1. Tiếp tục **thống nhất luồng thông báo và hành vi Core/legacy trước khi chuyển thêm màn hình**. Tạo mới có mã/AddPost đã xong ở 2l; đăng lại có mã và giữ ngày/revision qua refresh cùng tab đã xong ở 2m. Còn client không gửi key, các ý định/tab độc lập và giới hạn lưu thao tác nêu trên. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
