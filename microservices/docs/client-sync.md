...
1. Tiếp tục **đồng bộ điều kiện thông báo follower khi duyệt manual (hạn tin/công ty)** trước khi chuyển thêm màn hình. Tạo mới có mã/AddPost xong ở 2l; đăng lại có mã/giữ ngày–revision qua refresh cùng tab xong ở 2m; thời điểm/kênh thông báo sau duyệt cho Core mới xong ở 2n; điều kiện đăng lại/hạn tin/quyền công ty và revision Core xong ở 2o. Còn chính sách duyệt AI/manual, client không gửi key/revision và giới hạn ý định/tab độc lập. Dashboard Socket.IO và publisher còn lại vẫn best-effort; không đồng nghĩa mọi event legacy đã bền.
