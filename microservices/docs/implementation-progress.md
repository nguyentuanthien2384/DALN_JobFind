...
Đồng bộ client: đợt 1 xử lý phiên/lỗi và polling AI; 2a hạn mức; 2b sửa tin độc lập/ngày hết hạn; 2c đăng lại/idempotency modern; 2d adapter biểu mẫu và đọc quản lý. CI có test/build frontend và tích hợp các writer. Còn chống ghi đè khi nhiều người cùng sửa, đồng bộ kiểm duyệt legacy, vòng đời UI giữ key/payload và xử lý phản hồi trước khi chuyển từng màn hình đăng tin. Màn hình AI/CV và nghiệm thu E2E còn riêng. Xem `client-sync.md` về cách áp dụng, giới hạn và thứ tự tiếp tục.
