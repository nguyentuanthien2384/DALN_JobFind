...
Đồng bộ client: đợt 1 xử lý phiên/lỗi và polling AI; 2a hạn mức; 2b sửa tin độc lập/ngày hết hạn; 2c đăng lại/idempotency modern; 2d adapter biểu mẫu và đọc quản lý; 2e precondition chống ghi đè cho lệnh sửa đã gửi phiên bản. CI có test/build frontend và tích hợp các writer. Tiếp theo đồng bộ kiểm duyệt legacy, chuyển các client chưa gửi phiên bản, vòng đời UI giữ key/payload và phản hồi trước khi chuyển từng màn hình đăng tin. Màn hình AI/CV và nghiệm thu E2E còn riêng. Xem `client-sync.md` về cách áp dụng, giới hạn và thứ tự tiếp tục.
