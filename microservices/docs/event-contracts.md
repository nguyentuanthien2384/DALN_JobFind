...
- Các hàm emit trực tiếp của backend legacy kiểm tra trước khi publish, bổ sung ID cho từng lần tạo message. Ngoài intent manual 2g và cập nhật tin manual 2h nêu trên, các đường này vẫn best-effort, chưa transactional outbox/confirm; gọi lại hàm emit là một event mới, không phải retry giữ nguyên ID. Không suy ra bảo đảm không mất/trùng cho mọi publisher legacy từ việc có schema.
